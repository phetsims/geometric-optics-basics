...
=============
"Geometric Optics: Basics" is an educational simulation in HTML5, by <a href="https://phet.colorado.edu/" target="_blank">PhET
...
<a href="https://phet.colorado.edu/sims/html/geometric-optics-basics/latest/geometric-optics-basics_en.html" target="_blank">Click here to
run "Geometric Optics: Basics".</a>
...
(5) Open in the browser: `http://localhost/geometric-optics-basics/geometric-optics-basics_en.html` (You will probably need to modify this
...
(3) Open in the
browser: `http://localhost/geometric-optics-basics/build/adapted-from-phet/geometric-optics-basics_en_adapted-from-phet.html` (You will
